...
public enum RuntimeEnv {
    ...
    master("Benchmark Client",
            "Intel(R) Core(TM) i5-4570 CPU @ 3.20GHz",
            "3.2 GHz",
            4,
            "31.9 GiB",
            "Microsoft Windows 10 build 19043 (64 bits)",
            "Java(TM) SE Runtime Environment (1.8.0_191-b12) Java HotSpot(TM) 64-Bit Server VM (25.191-b12)"),
    zhworkstation("Server workstation",
    ...
    ssworkstation("Server workstation",
            "Intel(R) Xeon(R) CPU E5-2650 v3 @ 2.30GHz",
            "2.3 GHz",
            20,
            "63.8 GiB",
    ...
    RuntimeEnv(){
        ...
        this.os = os.getManufacturer() +' '+ os.getFamily() +' '+ os.getVersionInfo().toString() +" ("+ os.getBitness()+" bits)";
    ...
    public static RuntimeEnv getEnv(String name) {
        for (RuntimeEnv env : RuntimeEnv.values()) {
            if (env.name().equals(name)) return env;
        }
        return unknown;
    }
    ...
    public static void main(String[] args) {
        System.out.println(getCurrentEnv()); //sun.arch.data.model  java.runtime.name
    ...
    public JSONObject toJson(){
        ...
        obj.put("cpu", cpu);
        obj.put("core", numOfPhysicalCores);
        obj.put("mem", physicalMem);
        obj.put("os", os);
        obj.put("jvm", jvm);
        return obj;
    }
...
//        printSoundCards(hal.getSoundCards());
    ...
    private static void printComputerSystem(final ComputerSystem computerSystem) {
        ...
        System.out.println("|--firmware: " + computerSystem.getFirmware().getName());
        System.out.println("|--firmware: " + computerSystem.getFirmware().getManufacturer());
        System.out.println("|--firmware: " + computerSystem.getFirmware().getDescription());
        System.out.println("|--baseboard: " + computerSystem.getBaseboard().getManufacturer());
        System.out.println("|--baseboard: " + computerSystem.getBaseboard().getModel());
        System.out.println("|--baseboard: " + computerSystem.getBaseboard().getVersion());
    }
