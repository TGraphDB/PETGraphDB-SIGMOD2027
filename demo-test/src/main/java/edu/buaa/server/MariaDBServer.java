...
public class MariaDBServer {
    ...
    public static void main(String[] args) throws Exception {
        AbstractSQLClient client = new MariaDBTemporalTableClient();
        client.init("localhost", 3306, dbName, parallelCnt, TemporalGraphPropertySchema.load(dataset));
        SQLSocketServer server = new SQLSocketServer(client, 8765);
