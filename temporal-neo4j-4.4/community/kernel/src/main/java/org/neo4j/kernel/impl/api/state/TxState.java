...
public class TxState implements TransactionState, RelationshipVisitor.Home
{
    ...
    public void accept( final TxStateVisitor visitor ) throws KernelException
    {
        ...
        if (nodeTemporalValueMap != null) {
            visitor.visitNodeTemporalPropertyCreation(nodeTemporalValueMap);
        }

        if (relTemporalValueMap != null) {
            visitor.visitRelationshipTemporalPropertyCreation(relTemporalValueMap);
        }
    }
    ...
    private MemTable nodeTemporalProperties = new MemTable();
    private MemTable relTemporalProperties = new MemTable();
    ...
    HashMap<Integer, ValueContentType> nodeTemporalValueMap = new HashMap<>(), relTemporalValueMap = new HashMap<>();

    @Override
    public void nodeDoCreateTemporalProperty(int propertyId, ValueContentType type) {
        nodeTemporalValueMap.put(propertyId, type);
        changed();
    }

    @Override
    public void relationshipDoCreateTemporalProperty(int propertyId, ValueContentType type) {
        relTemporalValueMap.put(propertyId, type);
        changed();
    }
}
