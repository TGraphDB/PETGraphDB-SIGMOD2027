        ...
        QueryContext
{
    ...
    @Override
    public void acquireNodeTemporalSharedLock(long nodeId, long propertyId, long start, long end) {
        acquireTemporalSharedLock(ResourceTypes.NODE, nodeId, propertyId, start, end);
        ktx.assertOpen();
    }

    @Override
    public void acquireNodeTemporalExclusiveLock(long nodeId, long propertyId, long start, long end) {
        acquireTemporalExclusiveLock(ResourceTypes.NODE, nodeId, propertyId, start, end);
        ktx.assertOpen();
    }

    @Override
    public void acquireRelationshipTemporalSharedLock(long relationshipId, long propertyId, long start, long end) {
        acquireTemporalSharedLock(ResourceTypes.RELATIONSHIP, relationshipId, propertyId, start, end);
        ktx.assertOpen();
    }

    @Override
    public void acquireRelationshipTemporalExclusiveLock(long relationshipId, long propertyId, long start, long end) {
        acquireTemporalExclusiveLock(ResourceTypes.RELATIONSHIP, relationshipId, propertyId, start, end);
        ktx.assertOpen();
    }
    ...
    private void acquireTemporalSharedLock(ResourceType type, long entityId, long propertyId, long start, long end) {
        ktx.lockClient().acquireTemporalShared(ktx.lockTracer(), type, entityId, propertyId, start, end);
    }

    private void acquireTemporalExclusiveLock(ResourceType type, long entityId, long propertyId, long start, long end) {
        ktx.lockClient().acquireTemporalExclusive(ktx.lockTracer(), type, entityId, propertyId, start, end);
    }
