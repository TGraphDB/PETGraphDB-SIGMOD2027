...
public class DefaultForceOperation implements CheckPointerImpl.ForceOperation
{
    ...
    private final TemporalStorageProxy temporalStore;

    public DefaultForceOperation( IndexingService indexingService, StorageEngine storageEngine, TemporalStorageProxy temporalStore )
    {
