    ...
    public synchronized void start()
    {
        ...
        try
        {
            ...
            storageEngine = storageEngineFactory.instantiate( fs, databaseLayout, databaseConfig, databasePageCache, tokenHolders, databaseSchemaState,
                    ...
                    temporalStorageProxy.getNodeStore(), temporalStorageProxy.getRelStore() );
            ...
            CheckPointerImpl.ForceOperation forceOperation =
                    new DefaultForceOperation( indexingService, storageEngine, temporalStorageProxy );
            ...
            life.add(temporalStorageProxy);
            databaseDependencies.satisfyDependency(temporalStorageProxy);
