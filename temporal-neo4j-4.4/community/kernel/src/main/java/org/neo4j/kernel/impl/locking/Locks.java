...
public interface Locks
{
    ...
    interface Client extends ResourceLocker, AutoCloseable
    {
        ...
        default void acquireTemporalShared(LockTracer tracer, ResourceType resourceType, long entityId, long propertyId, long start, long end) {
            throw new UnsupportedOperationException(new TGraphNotImplementedException());
        }

        default void acquireTemporalExclusive(LockTracer tracer, ResourceType resourceType, long entityId, long propertyId, long start, long end) {
            throw new UnsupportedOperationException(new TGraphNotImplementedException());
        }
    }
