...
public interface TransactionState extends ReadableTransactionState
{
    ...
    default MemTable getNodeTemporalProperties() {
        throw new UnsupportedOperationException(new TGraphNotImplementedException());
    }

    default MemTable getRelationshipTemporalProperties() {
        throw new UnsupportedOperationException(new TGraphNotImplementedException());
    }

    default void nodeDoSetTemporalProperty(TemporalPropertyWriteOperation operation) {
        throw new UnsupportedOperationException(new TGraphNotImplementedException());
    }

    default void relationshipDoSetTemporalProperty(TemporalPropertyWriteOperation op) {
        throw new UnsupportedOperationException(new TGraphNotImplementedException());
    }

    default void nodeDoCreateTemporalProperty(int propertyId, ValueContentType type) {
        throw new UnsupportedOperationException(new TGraphNotImplementedException());
    }

    default void relationshipDoCreateTemporalProperty(int propertyId, ValueContentType type) {
        throw new UnsupportedOperationException(new TGraphNotImplementedException());
    }
}
