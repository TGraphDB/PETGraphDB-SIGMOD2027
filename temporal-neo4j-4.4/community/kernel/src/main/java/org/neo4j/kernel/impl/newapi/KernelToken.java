...
public class KernelToken implements Token
{
    ...
    @Override
    public void nodeCreateTemporalPropertyType(int propertyId, ValueContentType type) {
        ktx.assertOpen();
        TransactionState txState = ktx.txState();
        txState.nodeDoCreateTemporalProperty(propertyId, type);
    }

    @Override
    public void relationshipCreateTemporalPropertyType(int propertyId, ValueContentType type) {
        ktx.assertOpen();
        TransactionState txState = ktx.txState();
        txState.relationshipDoCreateTemporalProperty(propertyId, type);
    }
}
