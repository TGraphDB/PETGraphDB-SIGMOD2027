...
public final class Recovery
{
            ...
            throws IOException
    {
        ...
        TemporalStorageProxy temporalStorageProxy = new TemporalStorageProxy(databaseLayout);
        try {
            temporalStorageProxy.start();
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
        recoveryLife.add(temporalStorageProxy);
        ...
        StorageEngine storageEngine = storageEngineFactory.instantiate( fs, databaseLayout, config, databasePageCache, tokenHolders, schemaState,
                ...
                tracers.getPageCacheTracer(), true, readOnlyChecker, memoryTracker, temporalStorageProxy.getNodeStore(), temporalStorageProxy.getRelStore() );
        ...
        CheckPointerImpl.ForceOperation forceOperation = new DefaultForceOperation( indexingService, storageEngine, temporalStorageProxy );
