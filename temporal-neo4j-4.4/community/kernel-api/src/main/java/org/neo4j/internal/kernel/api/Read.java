...
public interface Read
{
    ...
    default Object nodeGetTemporalProperty(TemporalPropertyReadOperation operation, ValueContentType type) {
        throw new UnsupportedOperationException(new TGraphNotImplementedException());
    }

    default Object relationshipGetTemporalProperty(TemporalPropertyReadOperation operation, ValueContentType type) {
        throw new UnsupportedOperationException(new TGraphNotImplementedException());
    }
}
