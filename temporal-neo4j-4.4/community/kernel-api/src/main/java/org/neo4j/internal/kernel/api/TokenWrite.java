...
public interface TokenWrite
{
    ...
    default void nodeCreateTemporalPropertyType(int propertyId, ValueContentType type) {
        throw new UnsupportedOperationException(new TGraphNotImplementedException());
    }

    default void relationshipCreateTemporalPropertyType(int propertyId, ValueContentType type) {
        throw new UnsupportedOperationException(new TGraphNotImplementedException());
    }
}
