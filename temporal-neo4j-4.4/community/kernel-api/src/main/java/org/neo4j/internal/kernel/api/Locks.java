...
public interface Locks
{
    ...
    default void acquireNodeTemporalSharedLock(long nodeId, long propertyId, long start, long end) {
        throw new UnsupportedOperationException(new TGraphNotImplementedException());
    }

    default void acquireNodeTemporalExclusiveLock(long nodeId, long propertyId, long start, long end) {
        throw new UnsupportedOperationException(new TGraphNotImplementedException());
    }

    default void acquireRelationshipTemporalSharedLock(long relationshipId, long propertyId, long start, long end) {
        throw new UnsupportedOperationException(new TGraphNotImplementedException());
    }

    default void acquireRelationshipTemporalExclusiveLock(long relationshipId, long propertyId, long start, long end) {
        throw new UnsupportedOperationException(new TGraphNotImplementedException());
    }
}
