...
public interface Write
{
    ...
    default void nodeSetTemporalProperty( TemporalPropertyWriteOperation operation )
            throws KernelException {
        throw new UnsupportedOperationException(new TGraphNotImplementedException());
    }

    default void relationshipSetTemporalProperty( TemporalPropertyWriteOperation operation ) throws EntityNotFoundException {
        throw new UnsupportedOperationException(new TGraphNotImplementedException());
    }
}
