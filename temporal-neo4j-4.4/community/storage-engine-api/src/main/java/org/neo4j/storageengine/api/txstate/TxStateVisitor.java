...
public interface TxStateVisitor extends AutoCloseable
{
    ...
    default void visitNodeTemporalPropertyChanges( MemTable changes ) {
        throw new UnsupportedOperationException(new TGraphNotImplementedException());
    }

    default void visitRelationshipTemporalPropertyChanges( MemTable changes ) {
        throw new UnsupportedOperationException(new TGraphNotImplementedException());
    }

    default void visitNodeTemporalPropertyCreation(HashMap<Integer, ValueContentType> changes) {
        throw new UnsupportedOperationException(new TGraphNotImplementedException());
    }

    default void visitRelationshipTemporalPropertyCreation(HashMap<Integer, ValueContentType> changes) {
        throw new UnsupportedOperationException(new TGraphNotImplementedException());
    }
    ...
    class Delegator implements TxStateVisitor
    {
        ...
        @Override
        public void visitNodeTemporalPropertyChanges( MemTable changes ) {
            actual.visitNodeTemporalPropertyChanges(changes);
        }

        @Override
        public void visitRelationshipTemporalPropertyChanges( MemTable changes ) {
            actual.visitRelationshipTemporalPropertyChanges(changes);
        }

        @Override
        public void visitNodeTemporalPropertyCreation( HashMap<Integer, ValueContentType> changes ) {
            actual.visitNodeTemporalPropertyCreation(changes);
        }

        @Override
        public void visitRelationshipTemporalPropertyCreation( HashMap<Integer, ValueContentType> changes ) {
            actual.visitRelationshipTemporalPropertyCreation(changes);
        }
