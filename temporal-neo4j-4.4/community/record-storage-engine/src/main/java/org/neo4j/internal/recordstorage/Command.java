...
public abstract class Command implements StorageCommand
{
    ...
    public static class NodeTemporalPropertyCommand extends Command
    {
        ...
        @Override
        public void serialize(WritableChannel channel) throws IOException {
            serialization.writeNodeTemporalPropertyCommand(channel, this);
        }
    ...
    public static class RelationshipTemporalPropertyCommand extends Command
    {
        ...
        @Override
        public void serialize(WritableChannel channel) throws IOException {
            serialization.writeRelationshipTemporalPropertyCommand(channel, this);
        }
    ...
    private static abstract class TemporalPropertyCreateCommand extends Command {
        private int propertyId;
        private ValueContentType type;

        public void init(int propertyId, ValueContentType type) {
        ...
        @Override
        public String toString(Mask mask) {
            return "property id: " + propertyId + ", type: " + type;
        }
    }

    public static class NodeTemporalPropertyCreateCommand extends TemporalPropertyCreateCommand {
        @Override
        public boolean handle(CommandVisitor handler) throws IOException {
            return handler.visitNodeTemporalPropertyCreateCommand(this);
        }

        @Override
        public void serialize(WritableChannel channel) throws IOException {
            serialization.writeNodeTemporalPropertyCreateCommand(channel, this);
        }
    }

    public static class RelationshipTemporalPropertyCreateCommand extends TemporalPropertyCreateCommand {
        @Override
        public boolean handle(CommandVisitor handler) throws IOException {
            return handler.visitRelationshipTemporalPropertyCreateCommand(this);
        }

        @Override
        public void serialize(WritableChannel channel) throws IOException {
            serialization.writeRelationshipTemporalPropertyCreateCommand(channel, this);
        }
    }
}
