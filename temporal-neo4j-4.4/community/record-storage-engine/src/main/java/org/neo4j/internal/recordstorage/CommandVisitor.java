...
import org.neo4j.internal.recordstorage.Command.NodeTemporalPropertyCommand;
import org.neo4j.internal.recordstorage.Command.RelationshipTemporalPropertyCommand;
import org.neo4j.internal.recordstorage.Command.NodeTemporalPropertyCreateCommand;
import org.neo4j.internal.recordstorage.Command.RelationshipTemporalPropertyCreateCommand;
...
public interface CommandVisitor
{
    ...
    default boolean visitNodeTemporalPropertyCommand(NodeTemporalPropertyCommand command) throws IOException {
        throw new UnsupportedOperationException(new TGraphNotImplementedException());
    }

    default boolean visitRelationshipTemporalPropertyCommand(RelationshipTemporalPropertyCommand command) throws IOException {
        throw new UnsupportedOperationException(new TGraphNotImplementedException());
    }

    default boolean visitNodeTemporalPropertyCreateCommand(NodeTemporalPropertyCreateCommand command) throws IOException {
        throw new UnsupportedOperationException(new TGraphNotImplementedException());
    }

    default boolean visitRelationshipTemporalPropertyCreateCommand(RelationshipTemporalPropertyCreateCommand command) throws IOException {
        throw new UnsupportedOperationException(new TGraphNotImplementedException());
    }
    ...
    class Adapter implements CommandVisitor
    {
        ...
        @Override
        public boolean visitNodeTemporalPropertyCommand(NodeTemporalPropertyCommand command) {
            return false;
        }

        @Override
        public boolean visitRelationshipTemporalPropertyCommand(RelationshipTemporalPropertyCommand command) {
            return false;
        }

        @Override
        public boolean visitNodeTemporalPropertyCreateCommand(NodeTemporalPropertyCreateCommand command) {
            return false;
        }

        @Override
        public boolean visitRelationshipTemporalPropertyCreateCommand(RelationshipTemporalPropertyCreateCommand command) {
            return false;
        }
    }
}
