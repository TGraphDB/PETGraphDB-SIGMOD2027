...
public abstract class LogCommandSerialization implements CommandReader
{
    ...
    public final Command read( ReadableChannel channel ) throws IOException
    {
        ...
        // 时态属性token
        case NeoCommandType.NODE_TEMPORAL_PROPERTY_CREATE_COMMAND:
            return readNodeTemporalPropertyCreateCommand(channel);
        case NeoCommandType.REL_TEMPORAL_PROPERTY_CREATE_COMMAND:
            return readRelationshipTemporalPropertyCreateCommand(channel);
        // 时态属性
        case NeoCommandType.NODE_TEMPORAL_PROPERTY_COMMAND:
            return readNodeTemporalPropertyCommand(channel);
        case NeoCommandType.REL_TEMPORAL_PROPERTY_COMMAND:
            return readRelationshipTemporalPropertyCommand(channel);
        default:
