...
public interface Entity
{
    ...
    default void setTemporalProperty(String key, TimePoint start, TimePoint end, Object value) {
        throw new UnsupportedOperationException(new TGraphNotImplementedException());
    }

    default void setTemporalProperty(String key, TimePoint time, Object value) {
        setTemporalProperty(key, time, TimePoint.NOW, value);
    }

    default Object getTemporalProperty(String key, TimePoint time) {
        throw new UnsupportedOperationException(new TGraphNotImplementedException());
    }

    default Object getTemporalProperty(String key, TimePoint startTime, TimePoint endTime, TemporalRangeQuery callBack) {
        throw new UnsupportedOperationException(new TGraphNotImplementedException());
    }

    default void removeTemporalProperty(String key) {
        setTemporalProperty(key, new TimePoint(0), TimePoint.NOW, null);
    }

    default void acquireTemporalSharedLock(String key, TimePoint start, TimePoint end) {
        throw new UnsupportedOperationException(new TGraphNotImplementedException());
    }

    default void acquireTemporalExclusiveLock(String key, TimePoint start, TimePoint end) {
        throw new UnsupportedOperationException(new TGraphNotImplementedException());
    }
}
